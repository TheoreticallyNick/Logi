...
class LogiConnect:
    ...
    def init_mqtt(mqtt):
        ...
        try:
            ...
            myCallbackContainer = CallbackContainer(self.myAWSIoTMQTTClient)
    ...
    def connect_cycle():
        ...
        while attempts <= 4:
            ...
            if attempts == 4:
                sleep_time = sleep_calc(self.wake_time)
    ...
    def main():
        ...
        self.myAWSIoTMQTTClient = init_mqtt(mqtt)
        ...
        while True:
            ...
            try:
                ...
                JSONpayload = json.dumps(
                    ...
                    'schem': self.schema, 'wake': self.wake_time, 'cyc': str(cycleCnt), 'err': err, 
